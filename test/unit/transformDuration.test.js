...
describe('Points of Concern', () => {
  ...
  it('should group and ungroup a more complex set of coordinates', async () => {
    ...
    const groupOne = mockData._generateGroupedTrailsData(getRandomCoordinates(), startTime, 25)
    ...
    const groupTwo = mockData._generateGroupedTrailsData(getRandomCoordinates(), (randomTrails[99].time + 300000), 45)
    ...
    const groupThree = mockData._generateGroupedTrailsData(getRandomCoordinates(), (randomTrailsTwo[99].time + 300000), 15)
